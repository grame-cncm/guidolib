...
//------------------------------------
    ...
    testMethod(): void {
        ...
        this.test("this.fGuidoEngine.getVersion()",                 this._checkVersion(this.fGuidoVersion));
        //this.test("this.fGuidoEngine.checkVersionNums(1, 6, 2)",    this._checkErrCode(GuidoErrCode.guidoNoErr));
        ...
        //this.test("this.fGuidoEngine.init()",                                           this._checkErrCode(GuidoErrCode.guidoNoErr));
        ...
        //this.test("this.fGuidoEngine.updateGR(this.fGr)",                               this._checkErrCode(GuidoErrCode.guidoNoErr));        
        //this.test("this.fGuidoEngine.updateGR(this.fGr, this.GuidoLayoutSettings)",     this._checkErrCode(GuidoErrCode.guidoNoErr));        
        ...
        //this.test("this.fGuidoEngine.setDrawBoundingBoxes(this.bbMap)",             this._checkVoid());
        ...
        //this.test("this.fGuidoEngine.resizePageToMusic(this.fGr)",                  this._checkIsNum());
        console.log("\n");        
        ...
        //this.test("this.fGuidoEngine.parserGetErrorCode(this.fP, 1, 1, this.fGMN)",    this._checkErrCode(GuidoErrCode.guidoNoErr));
        //this.test("this.fGuidoEngine.closeStream(this.fGuidoStream)",                  this._checkErrCode(GuidoErrCode.guidoNoErr));
        //this.test("this.fGuidoEngine.writeStream(this.fGuidoStream, this.fGMN)",       this._checkErrCode(GuidoErrCode.guidoNoErr));
        //this.test("this.fGuidoEngine.resetStream(this.fGuidoStream)",                  this._checkErrCode(GuidoErrCode.guidoNoErr));   
        //this.test("this.fGuidoEngine.closeParser(this.fP)",                            this._checkErrCode(GuidoErrCode.guidoNoErr));
        console.log("\n");       
