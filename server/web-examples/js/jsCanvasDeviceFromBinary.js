...
gU1D0cANVA$.SetFontColor = function(alpha, red, green, blue) {
  gU1D0cANVA$.FONT_COLOR = "rgb("+red+","+green+","+blue+","+(alpha/gU1D0cANVA$.CHAR_MAX_AS_FLOAT)+")"
}
...
gU1D0cANVA$.SelectPenColor = function(alpha, red, green, blue) {
  var strokeStyle = "rgb("+red+","+green+","+blue+","+(alpha/gU1D0cANVA$.CHAR_MAX_AS_FLOAT)+")"
  gU1D0cANVA$.PEN_COLORS.length = 0;
...
gU1D0cANVA$.PopPenColor = function() {
  ...
  if (gU1D0cANVA$.PEN_COLORS.length > 0) {
    gU1D0cANVA$.CANVAS.strokeStyle = PEN_COLORS[PEN_COLORS.length - 1];
  } else {
...
gU1D0cANVA$.PopPenWidth = function() {
  ...
  if (gU1D0cANVA$.PEN_WIDTHS.length > 0) {
    gU1D0cANVA$.CANVAS.lineWidth = PEN_WIDTHS[PEN_WIDTHS.length - 1];
  } else {
