...
\begin{tabularx}{\linewidth}{p{3cm}p{3cm}p{5cm}p{3cm}p{2.5cm}p{3.5cm}p{4cm}}
    ...
    &color&&&&&\\
    \hline
    \textbf{\textbackslash{}fermata}&type&fermata type&string&``regular''&``regular'' - ``short'' - ``long''&\\
...
\begin{tabularx}{\linewidth}{p{3cm}p{3cm}p{5cm}p{3cm}p{2.5cm}p{3.5cm}p{4cm}}
    ...
    %&lineStyle&glissando line style&string&``line''&``line'' - ``wavy''&\\ % Doesn't work yet
    &color&&&&&\\
    \hline
...
\begin{tabularx}{\linewidth}{p{3cm}p{3cm}p{5cm}p{3cm}p{2.5cm}p{3.5cm}p{4cm}}
    ...
    &dispNote&forces note display&duration string&[automatic]&``/1'' - ``/2'' - ``/4'' - ``/8'' - ``/16'' - &\\
    &dx - color&&&&&\\
    \hline
