Posting complete score
----------------------

| This service is used to create a new score. The URL is the root of the webserver. The score is in an request attribute called ``data``.
