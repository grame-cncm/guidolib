...
La micro-tonalité est également introduite dans les armures de clef libres. Elle s'exprime aussi sous forme de nombres flottants indiqués entre crochets.
...
La première portée de l'exemple de la figure \ref{fig:noteheads} peut donc être générée avec le code \guido{} suivant:
...
%***************GLISSANDO************************
\subsection{\emph{Glissandi}}\label{subsec:glissando}
...
Le chemin du fichier peut être absolu ou bien relatif par rapport au dossier \textsc{home} de l'utilisateur ou par rapport au répertoire contenant le fichier \gmn{} ouvert.
