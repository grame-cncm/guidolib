...
Ci-dessous figurent les principes de généraux du format de notation \guido . Ils sont fournits pour permette la compréhension de ce qui suit dans les sections suivantes. Pour plus de détails on peut se reporter à \cite{Dau:09a} ou \cite{guido}.
...
\end{code}
\includegraphics[width=7cm]{img/partitions/cluster.pdf}
...
Ce manque d'une exacte cohérence entre tempo et aspect graphique est également souligné dans "Music Notation in the Twentieth Century" de Kurt Stone \cite{stone1980music} : "Besides, the gradual increase or decrease in the number of beams makes exact indications of beat-units impossible" (p.124).
