...
%%%%%%%%%%% GUIDO %%%%%%%%%%%%%    
    ...
    \begin{itemize}
      ...
      \item Altérations : \#, \&
      \item Silences : \_
      \item Durées : de la quadruple croche (1/64) à la blanche (1/1)
      \item Tags : \begin{code} \textbackslash{}meter \textbackslash{}clef \textbackslash{}cresc \textbackslash{}noteFormat \end{code} ...
    \end{itemize}
...
% -------------------------------- Paramètres ---------------------------
    ...
    \begin{itemize}
      ...
      \item size
      \item color
      \item headsLeft, headsRight, headsCenter, headsNormal
      \item stemsOff, stemsAuto, stemsUp, stemsDown
    \end{itemize}
    \end{code}
...
% ---------------------------- Micro tonalités -----------------------------
    ...
    \begin{code} \textbackslash{}alter \textless{}detune\textgreater{} (note-series) \end{code}
...
% ---------------------------------- Clusters ----------------------------------
    ...
    \begin{code} \textbackslash{}cluster \textless{} params \textgreater{} (chord-series) \end{code}
...
% ------------------------------------ Trilles -----------------------------------------
    ...
    \begin{code} \textbackslash{}trill \textless{} params \textgreater{} (chord-series)\\ 
    \hspace{2mm} params :\\
      - tr = [ true | false ]\\
      - anchor  = [ note | tr ]
    \end{code}
