...
#if defined(__APPLE__) || defined(MACOSX)
        /**
         * Opens and reads a face suitcase file (mac only). Error is set.
         *
         * @param spec  font file mac spec.
         * @param face_index  The index of the face within the resource.  The first face has index 0.  
         */
        FTFace( const FSSpec  *spec, FT_Long face_index);
#endif
        /**
