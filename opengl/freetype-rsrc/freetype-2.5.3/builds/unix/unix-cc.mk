...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -DDARWIN_NO_CARBON -I/opt/local/include  -DFT_CONFIG_OPTION_SYSTEM_ZLIB  -DFT_CONFIG_OPTION_USE_BZIP2 -I/opt/local/include/libpng15  -DFT_CONFIG_OPTION_USE_PNG -I/opt/local/include/harfbuzz  -DFT_CONFIG_OPTION_USE_HARFBUZZ -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS :=  -L/opt/local/lib -lz  -lbz2 -L/opt/local/lib -lpng15  -L/opt/local/lib -lharfbuzz 
