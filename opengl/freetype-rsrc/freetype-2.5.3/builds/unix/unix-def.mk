...
LIBS_PRIVATE       := -lbz2
LIBS_CONFIG        := -lfreetype -L/opt/local/lib -lz -lbz2 -L/opt/local/lib -lpng15 -L/opt/local/lib -lharfbuzz
LIBSSTATIC_CONFIG  := -lfreetype -L/opt/local/lib -lz -lbz2 -L/opt/local/lib -lpng15 -lz -L/opt/local/lib -lharfbuzz
build_libtool_libs := 
ft_version         := 17.2.11
