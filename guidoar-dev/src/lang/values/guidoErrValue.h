...
#ifndef __guidoErrValue__
#define __guidoErrValue__
...
/*!
\brief An error value used when recursion reaches the limit
*/
class export guidoErrValue : public guidovalue
{
	protected:
				 guidoErrValue() : guidovalue() {}
		virtual ~guidoErrValue() {}

	public:
		static Sguidovalue create();
