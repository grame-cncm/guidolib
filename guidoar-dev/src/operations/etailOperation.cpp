...
SARMusic etailOperation::operator() ( const SARMusic& score1, const SARMusic& score2 )
{
	if (!score2) return 0;
...
//_______________________________________________________________________________
Sguidoelement etailOperation::operator() ( const Sguidoelement& score, unsigned int evIndex, unsigned int voiceIndex )
{
	...
	if (score) {
		...
		outscore = tailOperation::operator()(score, time);
	}
	return outscore;
}
