...
- webComponent.html is an sample on how to use html5 component for create a new html tag. A tag guido-viewer is created and integrated in the html page.
- canvasDevice.html use internal javascript device. This device draw on html canvas. To intialize canvas, use jsCanvasDevice.js like in sample (all variables initialized in jsCanvasDevice.js are use in build-in javascript).
