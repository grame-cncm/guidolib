...
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasBeginDrawCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasDrawMusicSymbolCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasDrawStringCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasEndDrawCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasGetFontColorCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasGetMusicFontCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasGetTextFontCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasLineCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasNotifySizeCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasOffsetOriginCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPolygonCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPopFillColorCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPopPenColorCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPopPenCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPopPenWidthCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPushFillColorCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPushPenColorCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPushPenCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasPushPenWidthCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasRectangleCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasSelectPenColorCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasSetFontAlignCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasSetFontColorCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasSetMusicFontCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasSetOriginCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasSetScaleCommand;
import fr.grame.simpleguidoeditor.drawcommand.command.AndroidCanvasSetTextFontCommand;
