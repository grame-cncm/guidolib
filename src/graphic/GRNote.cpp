...
GRNote::GRNote( GRStaff * grstaf,
  ...
  : GREvent(grstaf,abstractRepresentationOfNote,relativeTimePositionOfGRNote,durationOfGRNote), mCluster(NULL), mClusterNote(false),
  mARNote(abstractRepresentationOfNote)
{
