...
const char* kARColorParams		= "S,color,black,r";
...
const char* kARPageFormatParams	= "S,type,,r;U,w,,r;U,h,,r;U,lm,2cm,o;U,tm,5cm,o;U,rm,2cm,o;U,bm,3cm,o;S,color,black,o";
