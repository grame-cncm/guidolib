...
GuidoErrCode GUIDOPianoRollAdapter::setColorToVoice(PianoRoll *pr, int voiceNum, const std::string& color)
{
	return GuidoPianoRollSetColorToVoice(pr, voiceNum, color);
}
